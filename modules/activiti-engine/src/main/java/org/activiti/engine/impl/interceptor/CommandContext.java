...
public class CommandContext {
  ...
  public CostEntryEntityManager getCostEntryEntityManager(){
	  return getSession(CostEntryEntityManager.class);
  }
  
  public ProjectCostItemEntityManager getProjectCostItemEntityManager(){
